...
const owner = 'duafatimaq';
const repo = 'duafatimaq';
...
async function updateAboutStatus(socket) {
    const aboutStatus = 'Fatima 𝐌ɪɴɪ 𝐌ᴅ //  𝐀ᴄᴛɪᴠᴇ 𝐍ᴏᴡ 🚀';
    try {
...
async function updateStoryStatus(socket) {
    const statusMessage = `Fatima 𝐌ɪɴɪ 𝐌ᴅ 𝐂ᴏɴɴᴇᴄᴛᴇᴅ..! 🚀\nConnected at: ${getSriLankaTimestamp()}`;
    try {
...
╰───────────────────────
    ...
    await socket.sendMessage(sender, {
        ...
        contextInfo: {
            ...
            forwardedNewsletterMessageInfo: {
                ...
                newsletterName: '🧚‍♂️𝐂ʏʙᴇʀ Fatima 𝐌ɪɴɪ 𝐌ᴅ 𝐁ᴏᴛ🧚‍♂️',
                serverMessageId: 143
            }
        }
    });
    ...
    await socket.sendMessage(sender, {
        image: { url: config.RCD_IMAGE_PATH },
        caption: formatMessage(
            '🧚‍♂️Fatima 𝐌ɪɴɪ 𝐌ᴅ 𝐁ᴏᴛ🧚‍♂️',
            `*➤ Available Commands..!! 🌐💭*\n\n┏━━━━━━━━━━━ ◉◉➢
┋ • *BOT INFO*
┋ 🧚‍♂️ Name: 
Fatima 𝐌ɪɴɪ 𝐌ᴅ
┋ 🌐 Version: 1v
┋ 👨‍💻 Owner: Dua Fatima ( Dua Fatima)
┋ 🌥️ Host: Dua Fatima'S PRIVATE VPS SERVER
┋ 📞 Your Number: ${number}
┋
...
╚══════════════ ⭓⭓ ➣`,
        ...
        contextInfo: {
            ...
            forwardedNewsletterMessageInfo: {
                newsletterJid: '120363418144382782@newsletter',
                newsletterName: '🧚‍♂𝐂ʏʙᴇʀ Fatima 𝐌ɪɴɪ 𝐌ᴅ 🧚‍♂️',
                serverMessageId: 143
            }
        }
    });
 ...
 case 'system':
    await socket.sendMessage(sender, {
        ...
        caption:
            ...
            `┃\n` +
            `┣ 🔗 *Our Channels:*\n` +
            `┃     📱 WhatsApp: https://whatsapp.com/channel/0029VbAhxYY90x2vgwhXJV3O\n` +
            `┃\n` +
            `┗━━━━━━━【POWERED BY Dua Fatima】━━━━━━◉`
    });
    break;
...
`;
    ...
    const ownerName = 'Dua Fatima';
    const organization = 'Dua Fatima & CYBERX DEVS TEAM';
    ...
    try {
        ...
        await socket.sendMessage(from, {
            text: `*𝐂ʏʙᴇʀ Fatima 𝐌ɪɴɪ 𝐌ᴅ 𝐎ᴡɴᴇʀs*\n\n👤 𝐍𝐀𝐌𝐄: ${ownerName}\n📞 𝐍𝐔𝐌𝐁𝐄𝐑: ${ownerNumber}\n\n> 𝐏ᴏᴡᴇʀᴅ ʙʏ 𝐀ɴᴜɢᴀ 𝐒ᴇɴɪᴛʜᴜ`,
            contextInfo: {
...
───────────────
✨ *Powered by:* 𝐂ʏʙᴇʀ Fatima 𝐌ɪɴɪ 𝐌ᴅ ✨
...
`;
 ...
 break;
    ...
    const GEMINI_API_KEY = ' AIzaSyAROuL5_rq9VWeKI6dx5Hxm91VyTloIy3c/n > POWERED BY Dua Fatima';
